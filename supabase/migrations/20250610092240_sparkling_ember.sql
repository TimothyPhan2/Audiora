...
CREATE INDEX idx_user_quiz_results_passed ON user_quiz_results(passed);
...
CREATE TRIGGER update_quiz_passed_trigger
  BEFORE INSERT OR UPDATE ON user_quiz_results
  FOR EACH ROW
  EXECUTE FUNCTION update_quiz_passed_status();
